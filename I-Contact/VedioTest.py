...
cap = cv2.VideoCapture("How to sound smart in your TEDx Talk _ Will Stephen _ TEDxNewYork.mp4")
...
while True:
        ...
        if tracked_position.is_empty() == False and trackingQuality >= 8.75:
            ...
            if len(ListOfIndexNew)!=0:
                ...
                if False:
                    ...
                    """if start==False:
                        saveImage=imutils.resize(baseImage, width=400)
                        FaceProcess.FaceProcess.saveFace(saveImage,ListOfIndexNew)"""
    ...
    if key == ord("a"):
        ...
        for note in res:
            print (Count,' :- ',note)
            Count+=1
        print ("Number of frame",frameCount)
        break
